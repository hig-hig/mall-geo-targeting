...
def _csv_row(mesh: Mesh) -> dict[str, object]:
    ...
    for name in ("accessibility_used_components", "commercial_used_components", "facility_choice_used_modes", "facility_choice_used_weights", "required_groups_passed", "required_groups_missing", "used_features", "missing_features", "used_weights", "score_contributions"):
